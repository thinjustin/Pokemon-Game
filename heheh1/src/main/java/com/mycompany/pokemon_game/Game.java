...
public class Game extends javax.swing.JFrame {
    ...
    if ("Bulbasaur".equals(selectedPokemon)) {
        ...
        jLabel4.setIcon(resizeImage(pokemonPaths[0], 200, 150));
        ...
        jLabel4.setIcon(resizeImage(pokemonPaths[1], 200, 150));
        ...
        jLabel4.setIcon(resizeImage(pokemonPaths[2], 200, 150));
    }
...
private void declareWinner(String winner) {
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        Game choose1Frame = new Game();
        choose1Frame.setVisible(false);
    }
